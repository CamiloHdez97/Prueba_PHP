(function() {
    const enlaces = document.querySelectorAll('.enlacepais');
    const contenedor = document.querySelector('#uipais');
    ...
    function cargarPagina(e) {
        ...
        var url = e.target.dataset.viewpais; // Obtiene la URL del enlace
